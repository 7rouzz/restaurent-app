...
const navigation: NavigationItem[] = [
    ...
    { name: 'Offers', href: '#offer-section', current: false },
                ...
                <div className="mx-auto max-w-7xl p-3 md:p-6 lg:px-8">
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <Link href="#home-section">   <Image src="/images/Logo/Logo.png" alt="logo" width={60} height={60} /></Link>
                            <Link href="#home-section" className='text-2xl font-semibold text-black ml-4'>
                                    RLH Food
                                </Link>
                            </div>
                            ...
                            <div className='gap-6 hidden lg:flex'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <p className='text-lg font-medium'>+216 55 235 981</p>
                                </div>
